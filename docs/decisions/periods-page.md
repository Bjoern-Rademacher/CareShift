...
- UI Update has to be confirmed by api to keep things simple at this point - aiming for optimistic in the future
- Api returns a simple response to implement sucess & error in UI
- Modal shows sucess message, then closes short after
- Apart from one response no backend logic
